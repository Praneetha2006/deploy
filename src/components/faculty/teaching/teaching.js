...
const Teaching = () => {
 ...
 <Navbar/>
      ...
      <FaEnvelope size={15} color="black" />
            ...
            <div style={{paddingLeft:'50px'}} className="mail">
      <FaPhone size={15} color="black"/>
    <div className="pos" style={{width:'100px'}}> 9701113599</div>
    </div>
         <a href="Sureshbabu_bio.doc"> <div className="Profile" target="_blank">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/15MfA_n9cjDMgb9yE9siZafK0cfFc7bpE/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/13OHwRg5fNOh2nanU6VMQ5f2OSExG4tw3/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true " target="_blank"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/13SvUtgeuawkMhWrlNyuIcCFd0y1-uNup/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true" target="_blank"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/13GCPLMcYYUo4mmVUR6cX9p6gL9AqFzsy/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true" target="_blank"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/13JQZ50WuXOyarBXL-5grcZEOw8Sus2_4/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true" target="_blank"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
           ...
           <div className="pos">sreesatya.u@gmail.com  </div></div>
            ...
            <a href="Sureshbabu_bio.doc"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/1JGuyGaRKOcBcNHcmL8ImQ0sCosXg0SwV/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true"target="_blank"> <div className="Profile">view Profile</div></a>
        </div>
        ...
        <div className="item">
            ...
            <a href="https://docs.google.com/document/d/13NcI-QRMS8h_vAP9oL1ONS02GN96xEUx/edit?usp=drive_link&ouid=110412585339647980090&rtpof=true&sd=true" target="_blank"> <div className="Profile">view Profile</div></a>
        </div>
      </section>
    </div>
  )
